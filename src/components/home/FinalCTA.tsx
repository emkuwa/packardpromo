        ...
        >
          ...
          <div className="pt-4 border-t border-white/10">
            <Link
              ...
              onClick={() => trackEvent("link_click", { label: "final_cta_sabasaba" })}
              className="inline-flex items-center gap-2 text-silver-400 hover:text-promo-300 text-xs uppercase tracking-wider font-semibold transition-colors"
            >
              <span className="w-4 h-px bg-promo-500/60" />
              Sabasaba Exhibition Branding Services
