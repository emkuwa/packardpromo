...
const requestedProducts = [
  ...
  { slug: "rollup-banners", name: "Roll-up Banners", image: "/images/x-banner.jpg", price: 55000, originalPrice: 85000, badge: "Best Value", badgeColor: "from-emerald-500 to-teal-500", serviceSlug: "large-format-printing" },
  ...
  { slug: "pvc-banners", name: "PVC Banners", image: "/images/packard-2026/pvc-banner-printing-tanzania.webp", price: 12000, originalPrice: 18000, badge: "Trending", badgeColor: "from-cyan-500 to-blue-500", serviceSlug: "large-format-printing" },
  { slug: "shop-signboards", name: "Shop Signboards", image: "/images/packard-2026/shop-signboard-printing-dar-es-salaam.webp", price: 180000, originalPrice: 280000, badge: "Premium", badgeColor: "from-gold-500 to-amber-500", serviceSlug: "signage-solutions" },
  { slug: "car-branding", name: "Vehicle Branding", image: "/images/packard-2026/fleet-vehicle-branding-tanzania.webp", price: 350000, originalPrice: 500000, badge: "Premium", badgeColor: "from-gold-500 to-amber-500", serviceSlug: "vehicle-branding" },
  { slug: "stickers-labels", name: "Stickers & Labels", image: "/images/packard-2026/custom-stickers-labels-printing-tanzania.webp", price: 15000, originalPrice: 22000, badge: "Hot", badgeColor: "from-rose-500 to-red-500", serviceSlug: "digital-printing" },
  { slug: "folding-cartons", name: "Custom Packaging", image: "/images/packard-2026/custom-retail-packaging-tanzania.webp", price: 250, originalPrice: 380, badge: "Best Value", badgeColor: "from-emerald-500 to-teal-500", serviceSlug: "packaging-printing" },
