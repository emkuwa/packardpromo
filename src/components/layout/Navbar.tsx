...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="sm:hidden bg-packard-950/95 backdrop-blur-md border-b border-white/5">
          <a
            href="tel:+255716002790"
            className="flex items-center justify-center gap-2 h-9 text-white text-xs sm:text-sm font-semibold tracking-wide hover:text-promo-300 active:text-promo-400 transition-colors"
