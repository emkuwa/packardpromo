          ...
          <div className="p-6">
            ...
            <nav className="space-y-1 mb-6">
              {items.map((item) => (
                <Link
                  ...
                  href={item.href}
                  onClick={onClose}
                  className="block px-4 py-3 text-lg font-medium text-silver-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                >
                  {item.label}
                </Link>
              ))}
            ...
            <div className="border-t border-white/5 pt-6 mb-6">
              ...
              {services.map((s) => (
                <Link
                  ...
                  onClick={onClose}
                  className="block px-4 py-2.5 text-base text-silver-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                >
                  {s.title}
                </Link>
              ))}
            ...
            <div className="border-t border-white/5 pt-6 space-y-3">
              <a
                ...
                onClick={onClose}
                className="flex items-center justify-center gap-2 w-full px-6 py-3 text-base font-semibold rounded-full bg-packard-500/10 text-packard-200 border border-packard-400/30"
              >
              ...
              <Link
                ...
                className="block w-full text-center px-6 py-3.5 text-base font-semibold rounded-full bg-gradient-to-r from-promo-500 to-promo-400 text-white"
              >
                Get Instant Quote
              </Link>
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-6 py-3 text-base font-medium rounded-full bg-white/5 text-white border border-white/10"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-6 py-3 text-base font-medium rounded-full bg-green-500/10 text-green-300 border border-green-500/20"
              >
